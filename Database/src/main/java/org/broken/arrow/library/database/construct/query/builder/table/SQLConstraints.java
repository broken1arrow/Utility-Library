...
public class SQLConstraints {
  ...
  public static SQLConstraints primaryKeys(String... columns) {
    ...
    public static SQLConstraints autoIncrement(final DatabaseType type) {
      switch (type) {
        case SQLITE:
          // SQLite kräver exakt detta direkt efter INTEGER PRIMARY KEY AUTOINCREMENT
          return new SQLConstraints("AUTOINCREMENT");
        case POSTGRESQL:
          // Modern SQL-standard för Postgres
  ...
  public static boolean isAutoIncrement(SQLConstraints constraints) {
    ...
    return constraints.value.startsWith("AUTOINCREMENT") || constraints.value.startsWith("AUTO_INCREMENT") || constraints.value.startsWith("GENERATED BY DEFAULT AS IDENTITY");
