package org.broken.arrow.library.database.construct.query.builder.statement.insertbuilder;

/**
 * Represents a single column-value pair for use in an SQL {@code INSERT} statement.
 * <p>
 * This class is typically used with {@link InsertHandler} to store column names and their
