...
import org.broken.arrow.library.database.builders.tables.ColumnWrapper;
import org.broken.arrow.library.database.utility.SQLCommandPrefix;
 ...
 * </p>
 * <p>
 * - It is essential to set the execution type, such as SELECT, INSERT, etc., using {@link SqlQueryBuilder.Builder#selectColumns(char)}.
 * </p>
 * <p>
 * - For INSERT,REPLACE or MERGE and UPDATE queries, ensure you call {@link SqlQueryBuilder.Builder#into()} or {@link SqlQueryBuilder.Builder#update()}.
 * to specify the columns and values.
 * </p>
 * <p>
 * - For SELECT and DELETE queries, use {@link SqlQueryBuilder.Builder#from()} and optionally {@link SqlQueryBuilder.Builder#where(String)} to set the table and conditions.
 * </p>
 *
...
public class SqlQueryBuilder {
	...
	/**
	 * Retrieves the column-value map set by {@link SqlQueryBuilder.SqlCommandPartBuilder#setParameterizedValues(java.util.Map)}.
	 *
