...
/**
 * Represents the primary SQL command prefixes that define the type of operation
...
public enum SQLCommandPrefix {
    ...
    /**
     * Checks whether the given text contains any of the defined command prefixes.
     * <p>
     * The check is case-sensitive and based on whether the {@link #getKey()}
     * value contains the provided text (converted to a string via concatenation).
     * </p>
     *
     * @param text the text to check; typically a {@link String}
     * @return {@code true} if any command prefix contains the given text; {@code false} otherwise
     */
    ...
    /**
     * Returns the SQL keyword or sequence for this command prefix.
     *
     * @return the SQL command keyword
     */
