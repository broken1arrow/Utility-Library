...
public final class CompMetadata {
    ...
    /**
     * Create an instance of CompMetadata.
     *
     ...
     * @return a string that combines the tre values.
     */
    ...
    /**
     * Sets a {@link NamespacedKey} in the {@link PersistentDataContainer} of the given
     * {@link TileState}.
     * <p>
     * A {@link TileState} represents a block state that can store custom data
     * (via a persistent data container) and is typically associated with blocks
     * that have a tile entity (e.g., chests, signs, banners).
     *
     * @param tile  the {@code TileState} on which to store the data
     * @param key   the string key (will be converted into a {@link NamespacedKey} using the plugin's namespace)
    ...
    /**
     * Checks whether the given {@link TileState} has a specific {@link NamespacedKey}
     * set in its {@link PersistentDataContainer}.
     *
     * @param tile the {@code TileState} to check
     * @param key  the string key (will be converted into a {@link NamespacedKey} using the plugin's namespace)
     * @return {@code true} if the key exists and is associated with a value; {@code false} otherwise
     */
     ...
     *
     * @param entity the entity to receive the PersistentDataHolder.
     * @param key    The key set.
     * @return persistent metadata for the key or {@code null} if could not find the value.
     */
     ...
     * @param entity the entity to receive the PersistentDataHolder.
     * @param key    The key set.
     * @param value  The value to set, if null it null or empty it will remove the set object if it exists.
     */
