...
/**
 * Provides version-independent access to Minecraft's internal NBT compound
 * implementation.
 *
 * <p>This interface abstracts the underlying NMS implementation and allows
 * interaction with compound data without directly depending on version-specific
 * Minecraft classes.</p>
 *
 * <p>The backing handle may represent either an internal
 * {@code NBTTagCompound} instance or the {@code CustomData} representation
 * introduced in Minecraft 1.20.5.</p>
 */
public interface NbtCompoundAccessor {

    /**
     * Checks whether the NBT compound contains the specified key.
     *
    ...
    /**
     * Removes the value associated with the specified key from the NBT compound.
     *
    ...
    /**
     * Returns the underlying Minecraft internal compound handle.
     *
     * <p>The returned object is version dependent and may represent either
     * {@code NBTTagCompound} or the {@code CustomData} implementation used in
     * Minecraft 1.20.5 and newer.</p>
     *
     * @return the underlying NMS compound handle
     */
    @Nonnull
    Object getHandle();
}
